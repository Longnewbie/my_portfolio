    ...
    <div className="projects-container" id="projects">
      ...
      <div className="projects-grid">
        <div className="project">
          <a href="https://soundwave.com.vn/" target="_blank" rel="noreferrer">
            <img src={mock10} className="zoom" alt="thumbnail" width="100%" />
          </a>
          <a href="https://soundwave.com.vn/" target="_blank" rel="noreferrer">
            <h2>Soundwave – Music Streaming & Real-time Chat Platform</h2>
          </a>
          <p>
            Designed and developed a full-stack music streaming platform using
            React, Node.js, Express.js, and MongoDB to strengthen my skills in
            backend development, RESTful API design, real-time communication,
            and application deployment.
          </p>
        </div>
        <div className="project">
          <a
            href="https://vie-jobs.vercel.app/"
            target="_blank"
            rel="noreferrer"
          >
          ...
          <a
            ...
            rel="noreferrer"
          >
            <h2>Recruitment Platform – VIEJOBS</h2>
          </a>
          <p>
            Designed and developed a full-stack recruitment platform using
            React, Node.js, Express.js, and MongoDB, focusing on RESTful API
            development, maintainable backend architecture, and scalable web
            application design.
          </p>
        </div>
        <div className="project">
          <a
            href="https://propersol2-lochat.onrender.com/login"
            target="_blank"
            rel="noreferrer"
          >
          ...
          <a
            ...
            rel="noreferrer"
          >
            <h2>Lochat – Real-time Chat Platform</h2>
          </a>
          <p>
            Designed and developed a real-time chat application using React,
            Node.js, Express.js, MongoDB, and Socket.IO, emphasizing RESTful API
            development and WebSocket-based communication.
          </p>
        </div>
        <div className="project">
          <a
            href="https://github.com/Longnewbie/project_mamagement"
            target="_blank"
            rel="noreferrer"
          >
          ...
          <p>
            Designed and developed a full-stack project management platform
            using React, Node.js, Express.js, and MongoDB, applying modular
            design principles and building reliable backend services for
